...
const TopBar = () => {
    ...
    return (
        <nav className="flex justify-between p-3 pr-0">
            ...
            <div className={`flex-col transition-all duration-300 ease-in-out absolute top-0 right-0 -z-10 p-5 pt-20 bg-white h-screen w-[275px] ${isNavOpen? 'flex': 'hidden'} md:hidden`}>
